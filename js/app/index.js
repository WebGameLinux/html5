		...
		if(qr=='1') {
			...
			if(h.html()=='') {
				...
				if($.support.leadingWhitespace) {
					h.qrcode({'width':180,'height':180,correctLevel:0,'text':u});
				} else {
					h.qrcode({'render':'table','width':180,'height':180,correctLevel:0,'text':u});
				}
			}
		} else {
