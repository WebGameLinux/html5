<!--param start-->
    //修改cdn的绝对路径（测试环境）
    fis.config.set('cdn-path','http://test.nie.163.com/test15/fsqq_ydgw_20150304');
    //修改cdn的绝对路径（正式环境）
    fis.config.set('cdn-path-release','http://res.fsqq.netease.com/gw/15v1/m/');
    //修改雪碧图放大缩小倍数，默认是1，iphone是0.5
    fis.config.set('css-scale',0.5);
    //修改include文件的域名
    fis.config.set('include-host','http://fsqq.163.com/')
